...
import com.example.parking_management.jwt.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173/, https://aplicacion-de-gestion-para-parqueadero.vercel.app")); // Your frontend origin
