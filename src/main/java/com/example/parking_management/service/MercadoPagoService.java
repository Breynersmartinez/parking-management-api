...
import com.example.parking_management.dto.paymentsDTO.PayDTO;
...
public class MercadoPagoService {
    ...
    public PayDTO getPago(String id_payment) {
        ...
        // 'response' contendrá la respuesta de la solicitud, mapeada al tipo PayDTO.
        ResponseEntity<PayDTO> response = restTemplate.exchange(
                urlMeli + id_payment, // URL de la solicitud
                HttpMethod.GET, // Método HTTP GET
                entity, // Entidad que contiene los encabezados
                PayDTO.class // Clase de respuesta esperada
        );
